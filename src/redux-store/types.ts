...
export type ListsAction = UnsetTaskToEditAction | SetTaskToEditAction |
UnsetTaskToDeleteAction| SetTaskToDeleteAction | DeleteTaskAction |
AddTaskAction| SetSelectedListAction | AddListAction |
UpdateListAction | GetListByIdAction | DeleteListAction | SetListIdToDeleteAction|
GetListsAction | SetListToEditAction
